  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
        ...
        >
          <span className="block font-medium text-base md:text-lg text-muted-foreground mb-2 sm:mb-4">Introducing Averix | AI Agent On Arbitrum</span>
          <AnimatedShinyText className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            <AnimatedGradientText>
              Empower Tomorrow: Your AI Ally on Arbitrum Sepolia
            </AnimatedGradientText>
          </AnimatedShinyText>
        </h1>
        ...
        >
          Averix combines advanced AI capabilities with the power of Arbitrum blockchain to create a seamless, intuitive experience for managing digital assets.
        </p>
