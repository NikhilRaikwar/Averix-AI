  ...
  const features = [
    {
      ...
      description: "Securely set up and manage your Arbitrum Sepolia wallet with a single command.",
      category: "wallet"
    },
    {
      icon: Coins,
      title: "Token Creation",
      description: "Effortlessly deploy custom ERC-20 tokens like MTK on Arbitrum Sepolia.",
      category: "tokens"
    },
    {
      icon: CreditCard,
      title: "Balance Tracking",
      description: "Instantly check your ETH and token balances with real-time updates.",
      category: "wallet"
    },
    {
      icon: Send,
      title: "Transaction Power",
      description: "Send ETH or custom tokens and sign messages with seamless blockchain integration.",
      category: "transactions"
    },
    {
      icon: Droplets,
      title: "Faucet Guidance",
      description: "Get clear instructions on claiming testnet ETH from the Arbitrum faucet.",
      category: "resources"
    },
    {
      icon: Gauge,
    ...
    },
    {
      icon: TrendingUp,
      title: "Token Trends",
      description: "Discover trending tokens on Arbitrum Sepolia with live explorer data.",
      category: "tokens"
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description: "Interact with Nexlify using simple, natural commands for a seamless experience.",
      category: "resources"
    }
  ];
        ...
        <RevealOnScroll>
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Experience the future of blockchain interaction through our advanced AI agent built specifically for Arbitrum.
            </p>
          </div>
        </RevealOnScroll>
